  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden pt-16 lg:pt-20">
        ...
        {/* Subtle grain overlay - using CSS class */}
        <div className="absolute inset-0 grain-overlay" />
        
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="max-w-3xl animate-slide-up">
            <span className="inline-block px-3 py-1.5 rounded-full bg-amber-600/20 text-amber-100 text-sm font-medium mb-6 tracking-wide backdrop-blur-sm border border-amber-400/30">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/products"
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-amber-600 hover:bg-amber-500 text-white font-medium rounded-lg transition-all duration-200"
              >
                Shop Collection
              ...
              <Link
                href="/collections"
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-white/10 hover:bg-white/20 text-white font-medium rounded-lg border border-white/20 transition-all duration-200 backdrop-blur-sm"
              >
                Browse Collections
              </Link>
            </div>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce" aria-hidden="true">
          <svg className="w-5 h-5 text-amber-200/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            <div className="py-3 text-center">
              <div className="mx-auto w-10 h-10 rounded-lg bg-amber-100 flex items-center justify-center mb-2.5">
                <svg className="w-5 h-5 text-amber-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <h3 className="text-sm font-semibold text-gray-900 mb-0.5">Quality Guaranteed</h3>
              <p className="text-xs text-gray-600">Premium Malaysian Oak</p>
            </div>
            <div className="py-3 text-center">
              <div className="mx-auto w-10 h-10 rounded-lg bg-amber-100 flex items-center justify-center mb-2.5">
                <svg className="w-5 h-5 text-amber-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-sm font-semibold text-gray-900 mb-0.5">Secure Payment</h3>
              <p className="text-xs text-gray-600">Encrypted checkout</p>
            </div>
            <div className="py-3 text-center">
              <div className="mx-auto w-10 h-10 rounded-lg bg-amber-100 flex items-center justify-center mb-2.5">
                <svg className="w-5 h-5 text-amber-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-sm font-semibold text-gray-900 mb-0.5">Nationwide Delivery</h3>
              <p className="text-xs text-gray-600">Peninsular & East Malaysia</p>
            </div>
            <div className="py-3 text-center">
              <div className="mx-auto w-10 h-10 rounded-lg bg-amber-100 flex items-center justify-center mb-2.5">
                <svg className="w-5 h-5 text-amber-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-sm font-semibold text-gray-900 mb-0.5">Easy Returns</h3>
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 animate-slide-up">
            <h2 className="heading-2 text-gray-900 mb-3">Our Collections</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <Link href="/collections/breda" className="collection-card group relative rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-xl transition-all duration-500 animate-slide-up">
              <div className="relative aspect-[4/3] overflow-hidden">
                ...
                <div className="card-overlay absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                  <span className="w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-white text-gray-900 font-semibold rounded-lg hover:bg-gray-100 transition-colors shadow-lg">
                    Explore Breda
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                    </svg>
              ...
              <div className="p-5">
                <span className="inline-block px-2.5 py-1 text-xs font-medium text-amber-700 bg-amber-50 rounded-full mb-2.5">NestHouZ</span>
                <h3 className="heading-3 text-gray-900 mb-1.5">Breda</h3>
                <p className="text-gray-600 text-sm mb-3">Working desks, TV cabinets and sideboards in warm Walnut/Natural combinations.</p>
                <div className="flex flex-wrap gap-1 mb-3">
                  <span className="px-2 py-0.5 text-xs font-medium rounded bg-amber-100 text-amber-700">Cocoa</span>
                  <span className="px-2 py-0.5 text-xs font-medium rounded bg-amber-100 text-amber-700">White Marble</span>
                </div>
            ...
            <Link href="/collections/dover" className="collection-card group relative rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-xl transition-all duration-500 animate-slide-up" style={{ animationDelay: '100ms' }}>
              ...
              <div className="p-5">
                <span className="inline-block px-2.5 py-1 text-xs font-medium text-rose-700 bg-rose-50 rounded-full mb-2.5">NestHouZ</span>
                <h3 className="heading-3 text-gray-900 mb-1.5">Dover</h3>
                <p className="text-gray-600 text-sm mb-3">Complete living room collections with coffee, console, side tables and desks.</p>
                <div className="flex flex-wrap gap-1 mb-3">
                  <span className="px-2 py-0.5 text-xs font-medium rounded bg-rose-100 text-rose-700">Walnut</span>
                  <span className="px-2 py-0.5 text-xs font-medium rounded bg-rose-100 text-rose-700">Cocoa</span>
                </div>
            ...
            <Link href="/collections/castor" className="collection-card group relative rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-xl transition-all duration-500 animate-slide-up" style={{ animationDelay: '200ms' }}>
              ...
              <div className="p-5">
                <span className="inline-block px-2.5 py-1 text-xs font-medium text-purple-700 bg-purple-50 rounded-full mb-2.5">Luooma</span>
                <h3 className="heading-3 text-gray-900 mb-1.5">Castor</h3>
                <p className="text-gray-600 text-sm mb-3">Minimalist three-tone finish combinations for modern entertainment centers.</p>
                <div className="flex flex-wrap gap-1 mb-3">
                  <span className="px-2 py-0.5 text-xs font-medium rounded bg-purple-100 text-purple-700">Black</span>
                  <span className="px-2 py-0.5 text-xs font-medium rounded bg-purple-100 text-purple-700">Natural</span>
                  <span className="px-2 py-0.5 text-xs font-medium rounded bg-purple-100 text-purple-700">Space Blue</span>
                </div>
          ...
          <div className="text-center mt-10 animate-slide-up">
            <Link href="/collections" className="inline-flex items-center gap-2 px-7 py-3.5 bg-white border-2 border-gray-200 text-gray-900 font-semibold rounded-lg hover:bg-gray-50 hover:border-amber-300 transition-all">
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 animate-slide-up">
            <div>
              <h2 className="heading-2 text-gray-900 mb-1.5">Featured Products</h2>
                ...
                >
                  <div className="relative aspect-square overflow-hidden bg-gray-50">
                    ...
                    <div className="absolute top-3 left-3 right-3 flex flex-col gap-1.5">
                      {product.is_new && (
                        <span className="badge badge-primary badge-success text-xs px-2 py-1 self-start">New</span>
                      )}
                      {product.is_bestseller && (
                        <span className="badge badge-primary text-xs px-2 py-1 self-start">Bestseller</span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="p-4">
                    ...
                    <h3 className="product-card-title font-medium text-gray-900 mb-1.5 line-clamp-1 group-hover:text-amber-700 transition-colors">
                      {product.name}
                    </h3>
      ...
      <section className="py-16 lg:py-24 bg-amber-900 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="heading-2 mb-3">Ready to Transform Your Space?</h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            <div className="md:col-span-2">
              <h3 className="heading-3 mb-3">Lotten</h3>
              <p className="body text-gray-400 mb-5 max-w-sm leading-relaxed">
            ...
            <div>
              <h4 className="heading-4 mb-3">Shop</h4>
              <ul className="space-y-2.5">
                ...
                <li><Link href="/products?category=new" className="text-gray-400 hover:text-white transition-colors text-sm">New Arrivals</Link></li>
                <li><Link href="/products?category=bestseller" className="text-gray-400 hover:text-white transition-colors text-sm">Bestsellers</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li><Link href="/returns" className="text-gray-400 hover:text-white transition-colors text-sm">Returns & Exchanges</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li><Link href="/sustainability" className="text-gray-400 hover:text-white transition-colors text-sm">Sustainability</Link></li>
              </ul>
            </div>
          </div>
