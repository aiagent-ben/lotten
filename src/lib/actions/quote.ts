...
import { calculateQuotePrice, type PriceCalculationInput, type PriceCalculationOutput } from '@/lib/pricing/engine';
...
export async function generateQuote(
  ...
  try {
    ...
    const pricingInput: PriceCalculationInput = {
      ...
      shippingAddress: inquiry.shipping_address as Record<string, unknown> || {},
